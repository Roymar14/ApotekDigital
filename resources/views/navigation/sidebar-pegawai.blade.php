<div class="sidebar" data-color="orange">
    ...
    <div class="sidebar-wrapper" id="sidebar-wrapper">
      <ul class="nav">
        ...
        <li class="{{ request()->routeIs('pegawai.index') ? 'active' : ''}} mb-2">
          <a href="{{route('pegawai.index')}}">
            <i class="now-ui-icons design_app"></i>
            <p>Dashboard</p>
          </a>
        </li>
        <li class="{{request()->routeIs('pegawai.gaji') ? 'active' : ''}}">
          <a href="{{route('pegawai.gaji')}}">
        ...
        <li class="{{ request()->routeIs('pegawai.transaksi') ? 'active' : ''}} mb-2">
