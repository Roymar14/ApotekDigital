...
class PegawaiTransaksiController extends Controller
{
    public function index()
    {
        ...
        return view('pegawai.transaksi.transaksi', compact('transaksi'));
    }
    public function create()
    {
        $barang = barang::all(); // Mengambil semua data barang
        return view('pegawai.transaksi.create', compact('barang'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pegawai.transaksi')->with('success', 'Transaksi berhasil ditambahkan!');
    }
    public function edit($id)
    {
        $transaksi = Transaksi::findOrFail($id); // Mengambil data transaksi berdasarkan ID
        $barang = Barang::all(); // Mengambil semua data barang
        return view('pegawai.transaksi.edit', compact('transaksi', 'barang'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('pegawai.transaksi')->with('success', 'Transaksi berhasil diperbarui!');
    }
    public function delete($id)
{
    ...
    return redirect()->route('pegawai.transaksi')->with('success', 'Transaksi berhasil dihapus!');
}
}
